...
const EditLoad = (props) => {
  ...
  const onChangeTime = (time, name) => {
    ...
    setLoadDetail({ ...loadDetail, [name]: time });
  };
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <TimePicker
                  ...
                  format="24hr"
                  hintText="00:00"
                  onChange={(value) => onChangeTime(value, "pickTime")}
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div>
                  ...
                  <TimePicker
                    ...
                    format="24hr"
                    hintText="00:00"
                    onChange={(value) => onChangeTime(value, "pickTimeInTime")}
                    value={loadDetail.pickTimeInTime}
                    fullWidth
                    renderInput={(params) => (
                      <TextField className={"dateText"} {...params} />
                    )}
                ...
                <div>
                  ...
                  <TimePicker
                    ...
                    format="24hr"
                    hintText="00:00"
                    onChange={(value) => onChangeTime(value, "pickTimeOutTime")}
                    value={loadDetail.pickTimeOutTime}
                    fullWidth
                    renderInput={(params) => (
                      <TextField className={"dateText"} {...params} />
                    )}
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <TimePicker
                  ...
                  format="24hr"
                  hintText="00:00"
                  onChange={(value) => onChangeTime(value, "dropTime")}
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div>
                  ...
                  <TimePicker
                    ...
                    format="24hr"
                    hintText="00:00"
                    onChange={(value) => onChangeTime(value, "dropInTime")}
                    value={loadDetail.dropInTime}
                    fullWidth
                    renderInput={(params) => (
                      <TextField className={"dateText"} {...params} />
                    )}
                ...
                <div>
                  ...
                  <TimePicker
                    ...
                    format="24hr"
                    hintText="00:00"
                    onChange={(value) => onChangeTime(value, "dropOutTime")}
                    value={loadDetail.dropOutTime}
                    fullWidth
                    renderInput={(params) => (
                      <TextField className={"dateText"} {...params} />
                    )}
        ...
        >
          ...
          >
            ...
            <Stack direction="row" alignItems="center">
              ...
              <AiOutlineArrowDown style={{ marginLeft: 5, fontWeight: 500 }} />
            </Stack>
          </Stack>
        </div>
      </form>
