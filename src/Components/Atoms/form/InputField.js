...
const InputField = (props = {}) => {
    const {label = '', type = 'text', multiple = false, onChange, labelStyle = {}, direction = 'column', formGrpStyle={}, helperText=''} = props;
    ...
    return (
        <FormGroup style={direction === 'row' ? {display: 'flex', alignItems: 'center', ...formGrpStyle} : {...formGrpStyle}}>
            ...
            {!!helperText && <Form.Control.Feedback>{helperText}</Form.Control.Feedback>}
        </FormGroup>
    )
}
